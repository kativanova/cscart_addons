...
{$hide = $auth.user_type != "UserTypes::ADMIN"|enum}

{if $shippings}
    <div id="shippings_content">
        {if $has_permission}
            {hook name="shippings:bulk_edit"}
                {include file="views/shippings/components/bulk_edit.tpl"}
            {/hook}
        {/if}
        ...
        <div class="table-responsive-wrapper longtap-selection">
            ...
            <tr>
                ...
                {if !"ULTIMATE:FREE"|fn_allowed_for && !$hide}
