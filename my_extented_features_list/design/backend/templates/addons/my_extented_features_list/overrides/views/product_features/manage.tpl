                    ...
                    <div class="table-responsive-wrapper">
                        <table width="100%" class="table table-middle table--relative table-responsive">
                            ...
                            <tr>
                                ...
                                <th width="10%" class="right">{__("Products")}</th>
                            ...
                            {foreach $features as $p_feature}
                                ...
                                >
                                    ...
                                    <td width="10%" class="right nowrap" data-th="{__("Products")}">
                                            <a href="{"products.manage?feature_id=`$p_feature.feature_id`"|fn_url}">{$p_feature.products}</a>
