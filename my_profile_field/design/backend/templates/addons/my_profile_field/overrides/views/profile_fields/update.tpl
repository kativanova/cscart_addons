...
{literal}
<script>
function fn_show_additional_settings(value)
{
    Tygh.$('#social_media_link').toggleBy(!(value == 'L'));
}
</script>
{/literal}
...
<div class="cm-tabs-content">
    <div id="content_tab_new_profile{$id}">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                {if $field.field_type !== "ProfileFieldTypes::STATE"|enum && $field.field_type !== "ProfileFieldTypes::COUNTRY"|enum && $field.field_type !== "ProfileFieldTypes::ADDRESS_TYPE"|enum}
                    <select id="elm_field_type" name="field_data[field_type]" onchange="fn_check_field_type(this.value, 'tab_variants{$id}'); fn_show_additional_settings(this.value);" {if $block_fields}disabled="disabled"{/if}>
                        ...
                        <option value="L" {if $field.field_type == "L"}selected="selected"{/if}>{__("my_profile_field.social_media_link")}</option>
                        {if $block_fields}
        ...
        <div id='social_media_link' class="control-group {if $field.field_type != "L"}hidden{/if}">
        <label for="elm_social_media_link" class="control-label {if $field.field_type === "L"}cm-required{/if}">{__("my_profile_field.social_media_link_domain")}:</label>
            <div class="controls">
                <input id="elm_social_media_link" class="input-text-short" type="text"
                    name="field_data[social_media_link]" value="{$field.social_media_link}" />
                <p class="muted description">{__("my_profile_field.social_media_link_tooltip")}</p>
            </div>
        </div>
